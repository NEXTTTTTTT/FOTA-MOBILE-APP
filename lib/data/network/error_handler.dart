      ...
      case DioErrorType.response:
        switch(error.response!.statusCode)
        {
          ...
          case ResponseCode.UN_AUTHORIZED:
            return DataSource.UN_AUTHORIZED.getFailure();
...
extension DataSourceExtension on DataSource {
  Failure getFailure() {
    switch (this) {
      ...
      case DataSource.UN_AUTHORIZED:
        return Failure(
            ResponseCode.UN_AUTHORIZED, ResponseMessage.UN_AUTHORIZED);
...
class ResponseCode {
  ...
  static const int UN_AUTHORIZED = 401; // failure user not authorized
...
class ResponseMessage {
  ...
  static const String NO_CONTENT =
      "success with no content"; // sucess with no content
  static const String BAD_REQUEST =
      "bad request,try again later"; // failure, api rejected the request
  static const String FORBIDDEN =
      "forbidden request, try again"; // failure , api rejected the request
  static const String UN_AUTHORIZED =
      "user is not authorized"; // failure user not authorized
  static const String NOT_FOUND = "url is not found, try again later";
  // failure , api url is not correct and not found
  static const String INTERNAL_SERVER_ERROR =
      "some thing went wrong"; // failure , crash happened in server side
...
class ApiInternalStatus
{
  ...
  static const int INVALID_TOKEN = 2;
}
